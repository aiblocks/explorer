...
const HOME_PUBLIC = 'https://explorer.aiblocks.io'
const HOME_TESTNET = 'https://explorer-testnet.aiblocks.io'
...
const networkType = hostnameToNetworkType('explorer-testnet.aiblocks.io')
