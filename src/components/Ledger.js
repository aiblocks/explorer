...
const responseToState = rsp => {
  ...
  // NOTE: as at 11 March 2018 testnet horizon returns base values in sectors
              ...
              <Table>
                <tbody>
                  <DetailRow label="base.fee">
                    <FormattedNumber value={baseFee} /> sectors
                  </DetailRow>
                  ...
                  <DetailRow label="fee.pool">
                    <FormattedNumber value={feePool} /> DLO
                  </DetailRow>
                  <DetailRow label="total.coins">
                    <FormattedNumber value={totalCoins} /> DLO
                  </DetailRow>
